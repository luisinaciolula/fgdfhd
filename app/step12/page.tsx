    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="bg-black">
        <div className="flex items-center justify-between p-4">
          ...
          <div className="text-white text-sm">8/18</div>
        </div>

        {/* Progress Bar */}
        <div className="w-full bg-gray-800 h-1">
          <div className="bg-green-400 h-1" style={{ width: "44.44%" }}></div>
        </div>
      </header>
      ...
      <div className="flex flex-col items-center px-4 max-w-4xl mx-auto py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-white text-3xl font-bold mb-4 text-balance">Do you know anything about trading?</h1>
        </div>
